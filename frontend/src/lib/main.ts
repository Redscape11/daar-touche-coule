...
import type { P1_Cruiser, P1_Destroyer, P2_Cruiser, P2_Destroyer } from '$/Ship.sol'
...
export const p1Cruiser = () => contracts.P1_Cruiser.address
export const p1Destroyer = () => contracts.P1_Destroyer.address
export const p2Cruiser = () => contracts.P2_Cruiser.address
export const p2Destroyer = () => contracts.P2_Destroyer.address
